		...
		<div className="container-comodidades">
			...
			<div className="row">
				...
				<div className="item">
					<img src={Piscina} alt="" />
					<p>
						<strong>Piscina exterior</strong> habilitada en temporada de verano
					</p>
				</div>
			</div>
			...
			<div className="row">
				...
				<div className="item">
					<img src={Ropa} alt="" />
					<p>
						<strong>Ropa blanca</strong>: sábanas, toallones para el interior de
						la cabaña y toallones de pileta
					</p>
				</div>
				<div className="item">
