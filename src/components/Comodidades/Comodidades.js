...
export default function Comodidades() {
	...
	return (
		<div className="container-comodidades" ref={comodidadesRef}>
			{isVisible && (
				<>
					<div className="row">
						<div className="item">
					...
					<div className="row">
						...
						<div className="item">
							<img src={Quincho} alt="" />
							<p>
								<strong>Quincho</strong> con asador propio, mesa y sillas, un
								baño extra con ducha
							</p>
						</div>
					...
					<div className="row">
						...
						<div className="item">
							<img src={Juegos} alt="" />
							<p>
								<strong>Entretenimiento</strong>: juegos de mesa, metegol,
								libros, juegos para niños
							</p>
						</div>
					</div>
					...
					<div className="row">
						...
						<div className="item">
							<img src={Ropa} alt="" />
							<p>
								<strong>Ropa blanca</strong>: sábanas, toallones para el
								interior de la cabaña y toallones de pileta
							</p>
						</div>
						<div className="item">
							<img src={Desayuno} alt="" />
							<p>
								<strong>Insumos para desayuno</strong>: saquitos de café,
								variedad de té, sobrecitos de leche en polvo y de azúcar
							</p>
						</div>
					</div>
				</>
